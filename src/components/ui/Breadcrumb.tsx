...
export function Breadcrumb({
  ...
  const getItemClasses = (isCurrent: boolean): string => {
    ...
    if (isCurrent) {
      return `${baseClasses} text-gray-200 bg-white/5 backdrop-blur-sm`;
    }
  ...
  return (
    <nav
      ...
      className={`flex w-full bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 ${getVariantClasses()} ${className}`}
    >
