      ...
      <div className="prose prose-gray max-w-none dark:prose-invert">
        ...
        <div className="space-y-6">
          ...
          <section>
            ...
            <p>
              <strong>Telefon:</strong> +49 711 5401-0<br />
              <strong>E-Mail:</strong> poststelle@lka.polizei.bwl.de<br />
          ...
          <section>
            ...
            <p>
              <strong>Präsident:</strong> Dr. Michael Kilchling<br />
              <strong>Vizepräsident:</strong> [Name wird aus Sicherheitsgründen nicht veröffentlicht]
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>Ministerium für Inneres, Digitalisierung und Migration Baden-Württemberg</strong><br />
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">Zuständige Kammer</h2>
            <p>
              Das Landeskriminalamt Baden-Württemberg ist eine Landesbehörde und unterliegt 
              nicht der Kammerzugehörigkeit.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>Berufsbezeichnung:</strong> Polizeivollzugsbeamte<br />
              <strong>Zuständige Kammer:</strong> Nicht zutreffend (Beamte)<br />
              <strong>Verliehen durch:</strong> Land Baden-Württemberg<br />
              <strong>Berufsrecht:</strong> Landesbeamtengesetz Baden-Württemberg (LBeamtG BW)
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>Pressestelle des Landeskriminalamts Baden-Württemberg</strong><br />
              Taubenheimstraße 85<br />
              70372 Stuttgart<br />
          ...
          <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              <strong>Stand:</strong> {new Date().toLocaleDateString('de-DE')}<br />
