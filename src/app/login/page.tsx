...
export default function Login() {
  ...
  const handleSetupDemoUsers = async () => {
    ...
    try {
      ...
      setError(
        "Fehler beim Erstellen der Demo-Benutzer. Bitte überprüfen Sie die Supabase-Konfiguration.",
      );
    } finally {
        ...
        <div className="w-full max-w-md">
          <div className="rounded-2xl border border-white/20 bg-white/10 p-8 backdrop-blur-sm">
            <div className="mb-8 text-center">
              <h1 className="mb-2 text-3xl font-bold text-white">Fahndung</h1>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-lg border border-white/10 bg-white/5 py-3 pr-4 pl-10 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-lg border border-white/10 bg-white/5 py-3 pr-12 pl-10 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
