-- 🔧 VOLLSTÄNDIGER FIX FÜR ALLE AKTUELLEN FEHLER
...
-- ============================================
-- 2. RLS POLICIES FÜR USER_PROFILES FIXEN
-- ============================================
...
-- ============================================
-- 6. TEST DER KORREKTUREN (OHNE FOREIGN KEY FEHLER)
-- ============================================

-- Test 1: Benachrichtigung erstellen (ohne Foreign Key)
...
BEGIN
  ...
  RAISE NOTICE '==============================================';
  RAISE NOTICE '';
  RAISE NOTICE '📧 EDGE FUNCTION DEPLOYEN:';
  ...
  RAISE NOTICE '   5. Kopieren Sie den Code aus supabase/functions/send-email/index.ts';
  RAISE NOTICE '   6. Klicken Sie auf "Deploy"';
  RAISE NOTICE '';
  RAISE NOTICE '🔧 CORS FIX:';
  RAISE NOTICE '   Die Edge Function hat jetzt korrekte CORS-Header';
  RAISE NOTICE '';
  RAISE NOTICE '📋 NÄCHSTE SCHRITTE:';
  RAISE NOTICE '   1. Deployen Sie die Edge Function';
